...
export default function LibraryNodeCard({ node }) {
    ...
    return (
        <motion.div
            ...
            className={`text-[#EEE] ml-1 mr-3 my-1 pointer-events-auto [box-shadow:0px_0px_6px_white] bg-[#22222240] rounded-md ${isHovered ? "backdrop-blur-sm" : "backdrop-blur-xlg"}`}
            tabIndex='-1'
            onClick={handleClick}
