...
export async function getNextRandomNode(currNodeID) {
    // console.log("nodes.js getNextRandomNode() typeof(currNodeID)", typeof(currNodeID))
    // console.log("nodes.js getNextRandomNode() currNodeID", currNodeID)
    try {
        ...
        console.log("getNextRandomNode() randNode:", randNode);
...
async function getWeightedRandomNode() {
    ...
    try {
        ...
        console.log("getWeightedRandomNode randNum",randNum, "randNode:", randNode);
        return randNode;
    } catch (error) {
        console.log("getWeightedRandomNode error:", error);
        return { error };
    }
}
