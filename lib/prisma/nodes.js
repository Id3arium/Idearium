...
export async function getUserNodes(userId) {
   try {
      console.log("nodes.getUserNodes userId:", userId)
      ...
      console.log("nodes.getUserNodes getting:", nodes.length, "nodes fromBD")
      ...
      console.error("nodes.getUserNodes error:", error)
      return error
   }
}
