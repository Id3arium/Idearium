...
export const nodesCountAtom = atom((get) => {
	return Object.keys(nodesAtom).length
});

export const addNodeAtom = atom(null, (get, set, newNode) => {
	console.log("addNodeAtom", newNode)

	const nodes = get(nodesAtom);
	nodes[newNode.id] = newNode;
	console.log("addNodeAtom nodes[newNode.id]", nodes[newNode.id])
	
	const frequencyDelta = newNode.frequency / get(nodesCountAtom)
...
export const removeNodeAtom = atom(null, (get, set, nodeIdToRemove) => {
	...
	const frequencyDelta = -nodeToDelete.frequency / get(nodesCountAtom)
...
export const currentNodeAtom = atom((get) => {
	...
	console.log("currentNodeAtom", get(nodeTimelineAtom)[currentTimelineIndex])
