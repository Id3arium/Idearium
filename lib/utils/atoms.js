...
export const currentNodeAtom = atom((get) => {
	...
	console.log("currentNodeAtom currentTimelineIndex", currentTimelineIndex)
...
export const addNodeAtom = atom(null, async (get, set, newNode) => {
	console.log("addNodeAtom addingasd node in client", newNode);
	...
	try {
		...
		console.log("addNodeAtom created node in DB", createdNode);
		set(nodesAtom, clientNodesAtom)
	} catch (error) {
...
export const removeNodeAtom = atom(null, async (get, set, nodeID) => {
	console.log("removeNodeAtom removing node", nodeID);
	...
	try {
		const removedNode = await API.removeNodeInDB(nodeID);
		console.log("removeNodeAtom removed node in DB", removedNode);
		set(nodesAtom, clientNodesAtom)
	} catch (error) {
	...
	console.log("removeNodeAtom modifyFrequenciesAtom");
});
...
export const resetNodeFrequenciesAtom = atom(null, (get, set) => {
	console.log("atoms.resetNodeFrequenciesAtom ")
...
export const amplifyFrequenciesAtom = atom(null, (get, set, freqModifier) => {
	...
	console.log("atoms.amplifyFrequenciesAtom: multiplying frequencies by:", freqModifier )
	const nodesCount = Object.keys(nodesDict).length
