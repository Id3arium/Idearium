...
export async function fetchNextRandomNode(currNode) {
    ...
    if (responseJson.res) {
        console.log('API.fetfetchNextRandomNode: randNodeData.node', responseJson.res)
...
export async function fetchNodeById(nodeID) {
    ...
    const responseJson = await res.json();
    if (responseJson.res) {
        console.log('API.fetchNodeById: node', responseJson.res)
...
export async function resetNodeFrequencies() {
    ...
    const responseJson = await res.json();
    console.log('API.resetNodeFrequencies: node updated', responseJson)
    return responseJson.res;
}